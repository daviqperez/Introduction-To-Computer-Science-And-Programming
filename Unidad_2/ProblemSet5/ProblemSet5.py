...
class NewsStory(object):
    def __init__(self, guid, title, subject, summary, link):
        """
        Initializates a NewsStory object with 5 attributes
    ...
    def get_subject(self):
        '''
        Used to safely access self.subject outside of the class
    ...
    def get_summary(self):
        '''
        Used to safely access self.summary outside of the class
